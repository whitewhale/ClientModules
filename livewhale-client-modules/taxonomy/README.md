This /live/taxonomy/___ endpoint provides additional JSON results for different taxonomies, in case the client wants to generate their own filters or displays programmatically.
