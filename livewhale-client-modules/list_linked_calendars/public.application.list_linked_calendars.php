...
if ($_LW->page==$_LW->REGISTERED_APPS['list_linked_calendars']['custom']['page_path']) { // if on the help page
	...
	->innerJoin('livewhale_tags2any', 'livewhale_tags2any.type="events_subscription" AND livewhale_tags2any.id2=livewhale_events_subscriptions.id')
	->innerJoin('livewhale_tags', 'livewhale_tags.id=livewhale_tags2any.id1')
	->innerJoin('livewhale_events_categories2any', 'livewhale_events_categories2any.type="events_subscription" AND livewhale_events_categories2any.id2=livewhale_events_subscriptions.id')
	->innerJoin('livewhale_events_categories', 'livewhale_events_categories.id=livewhale_events_categories2any.id1 AND livewhale_events_categories.type=1')
	->innerJoin('livewhale_events_categories2any AS livewhale_events_categories2any_audience', 'livewhale_events_categories2any_audience.type="events_subscription" AND livewhale_events_categories2any_audience.id2=livewhale_events_subscriptions.id')
	->innerJoin('livewhale_events_categories AS livewhale_events_categories_audience', 'livewhale_events_categories_audience.id=livewhale_events_categories2any_audience.id1 AND livewhale_events_categories_audience.type=2')
